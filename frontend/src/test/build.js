...
/* harmony export (immutable) */ __webpack_exports__["a"] = SET_TOKEN;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_Auth__ = __webpack_require__(12);


Object(__WEBPACK_IMPORTED_MODULE_0__utils_Auth__["a" /* login */])('root', 'root8888');
...
"use strict";
/* unused harmony export InvalidCredentialsException */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config_Api__ = __webpack_require__(41);
...
function login(username, password) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
    .post(__WEBPACK_IMPORTED_MODULE_4__config_Api__["b" /* URL */] + __WEBPACK_IMPORTED_MODULE_4__config_Api__["a" /* LOGIN */], data)
    .then(function (response) {
      __WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].dispatch(Object(__WEBPACK_IMPORTED_MODULE_3__actions__["a" /* setToken */])(response.data.token));
    })
    .catch(function (error) {
      // raise different exception if due to invalid credentials
      if (__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.get(error, 'response.status') === 400) {
...
function loggedIn() {
  return __WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].getState().token == null;
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_redux_logger__ = __webpack_require__(38);
...
const store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(__WEBPACK_IMPORTED_MODULE_2__reducers__["a" /* default */]);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(3), __webpack_require__(36)(module)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actions_types__ = __webpack_require__(10);
...
const token = (state = tokenInitialState, action) => {
  switch(action.type) {
    case __WEBPACK_IMPORTED_MODULE_1__actions_types__["a" /* SET_TOKEN */]:
      return action.data;
    default:
      return state;
  }
...
const appReducer = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* combineReducers */])({
  token,
})
...
const setToken = (data) => {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__types__["a" /* SET_TOKEN */],
    data
  }
}
